...
<main class="site-main" id="main-content">
    ...
    <div class="mo-ctas">
        ...
        <button class="btn btn-ghost" id="toggle-workload-table" type="button">Workload Details &#8595;</button>
    </div>

    <%-- 4 key metrics --%>
    <div class="compact-stats">
        <div class="compact-stat">
            <span class="compact-stat__value">${totalUsers}</span>
            <span class="compact-stat__label">Users</span>
        </div>
        <div class="compact-stat">
            <span class="compact-stat__value">${snapshot.totalJobs}</span>
            <span class="compact-stat__label">Jobs</span>
        </div>
        <div class="compact-stat">
            <span class="compact-stat__value">${snapshot.totalApplications}</span>
            <span class="compact-stat__label">Apps</span>
        </div>
        <div class="compact-stat compact-stat--alert">
            <span class="compact-stat__value">${alertCount}</span>
            <span class="compact-stat__label">Alerts</span>
        </div>
    </div>
    ...
    <section class="section">
        <h2 class="section__title">&#x26a0; Alerts &amp; Warnings</h2>
    ...
    <%-- Per-job breakdown (collapsed by default) --%>
    <div class="panel" id="workload-table-panel" style="display:none; margin-top: 1.25rem;">
...
if (toggleBtn && tablePanel) {
    toggleBtn.addEventListener('click', function () {
        ...
        toggleBtn.innerHTML = hidden ? 'Workload Details &#8593;' : 'Workload Details &#8595;';
    });
}
...
function loadWorkloadInsights() {
    ...
    btn.disabled = true;
    btn.textContent = 'Analyzing workload...';
    resultDiv.style.display = 'block';
    resultDiv.innerHTML = '<p>Analyzing workload data...</p>';
